package br.com.scrumlab.scrumlab_geocoder;
...
/**
 * ScrumlabGeocoderPlugin
 */
public class ScrumlabGeocoderPlugin implements MethodCallHandler {

  private Geocoder geocoder;

  public ScrumlabGeocoderPlugin(Context context) {
  ...
  public static void registerWith(Registrar registrar) {
    ...
    channel.setMethodCallHandler(new ScrumlabGeocoderPlugin(registrar.context()));
  }
  ...
  private void findAddressesFromQuery(final String address, final Result result) {
    ...
    final ScrumlabGeocoderPlugin plugin = this;
